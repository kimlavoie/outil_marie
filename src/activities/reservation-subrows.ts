...
export function addStaffRow(
  ...
  container.insertAdjacentHTML(
    ...
    <div id="${wrapperId}" class="distribution-row-wrapper" data-auto-generated="${autoGenerated ? "1" : ""}" style="margin-bottom: 8px; width: 100%;">
      <div id="${rowId}" class="distribution-row" style="grid-template-columns: 1.2fr 0.6fr 0.6fr 0.6fr 1fr 1fr auto auto; align-items: center;">
...
export function addServiceRow(
  ...
  container.insertAdjacentHTML(
    ...
    `
    <div id="${wrapperId}" class="distribution-row-wrapper" data-auto-generated="${autoGenerated ? "1" : ""}" style="margin-bottom: 8px; width: 100%;">
      <div id="${rowId}" class="distribution-row" style="grid-template-columns: 1.3fr 0.6fr 0.6fr 1fr 1fr auto auto; align-items: center;">
  ...
  return Array.from(card.querySelectorAll<HTMLInputElement>(".room-staff-list .distribution-row")!)
    .map(row => {
      ...
      return {
        ...
        custom_overtime_rate: wrapper ? parseFloat(wrapper.querySelector<HTMLInputElement>(".staff-custom-overtime-rate-input")!.value) || 0 : 0,
